...
class general extends Resource
{
	...
	public function saygeneral()
	{
			...
			$result = new Response(200, array("cyclosVersion" => "3.7.4",
 											   ...
 											   "welcomeMessage" => "Welcome to the open money LETSystem beta2",
 											   "principalType" => "USER",
 											   "credentialType" => "LOGIN_PASSWORD",
											   'images' => array(array('id' => 241,
																        'caption' => 'mobileSplash_large',
																        'thumbnailUrl' => 'http://openmoney.ca/beta2/webclient/res/icon/android/icon-72-hdpi.png',
																        'fullUrl' => 'http://openmoney.ca/beta2/webclient/res/screen/android/screen-hdpi-portrait.png',
																        'lastModified' => '2013-10-01T17:02:06.000+0000'),
											   					 array('id' => 240,
																        'caption' => 'mobileSplash_medium',
																        'thumbnailUrl' => 'http://openmoney.ca/beta2/webclient/res/icon/android/icon-48-mdpi.png',
																        'fullUrl' => 'http://openmoney.ca/beta2/webclient/res/screen/android/screen-mdpi-portrait.png',
																        'lastModified' => '2013-10-01T17:02:06.000+0000'),
											   					 array('id' => 207,
																        'caption' => 'mobileSplash_small',
																        'thumbnailUrl' => 'http://openmoney.ca/beta2/webclient/res/icon/android/icon-36-ldpi.png',
																        'fullUrl' => 'http://openmoney.ca/beta2/webclient/res/screen/android/screen-ldpi-portrait.png',
