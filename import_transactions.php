  ...
  if ($rawdata ) { //password check prior to processing
    ...
    foreach ($data as $line) {
      ...
      $line1 = exec_sql("INSERT into user_journal (tid,created,trading_account,with_account,currency,amount,description) 
                         ...
                         "insert into user_journal first line");
      $line2 = exec_sql("INSERT into user_journal (tid,created,trading_account,with_account,currency,amount,description) 
                         ...
                         "insert into user_journal second line");
      ...
      $journal = exec_sql("INSERT into journal (tid,date,buyer_id,seller_id,amount,description,tax) VALUES (?,?,?,?,?,?,?)",
			  array($tid,$date,$buyer_id,$seller_id,$amount,$description,$tax),"insert into journal");
      if (!$result1) {echo "nothing to process";exit;}
